  ...
  TheGraph.Edge = React.createFactory( React.createClass({
    ...
    componentDidMount: function () {
      ...
      if (this.props.onEdgeSelection) {
        ...
        domNode.addEventListener("click", this.onEdgeSelection);
      }
      ...
      if (this.props.showContext) {
        ...
        domNode.addEventListener("mousedown", this.handleDown);
        domNode.addEventListener("mouseup", this.handleUp);
      }
    },
    ...
    handleDown: function(event) {
      holdTimeout = window.setTimeout(this.showContext, 200);
    },
