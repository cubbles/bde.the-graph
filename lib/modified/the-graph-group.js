  ...
  TheGraph.Group = React.createFactory( React.createClass({
    ...
    componentDidMount: function () {
      ...
      if (this.props.isSelectionGroup) {
        ...
        ReactDOM.findDOMNode(this.refs.box).addEventListener("track", this.handleTrack);
      } else {
        ReactDOM.findDOMNode(this.refs.label).addEventListener("track", this.handleTrack);
      }
    ...
    handleTrack: function(event) {
      ...
      if (event.detail.state === 'track') {
        var deltaX = Math.round( event.detail.ddx / this.props.scale );
        var deltaY = Math.round( event.detail.ddy / this.props.scale );
